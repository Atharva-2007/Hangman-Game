...
icon = pygame.image.load("image_1.png")
...
# creating thw words list
words = ['PYGAME', 'PYTHON', 'JAVA', 'HELLO', 'WORLD', 'HANGMAN', 'TIME', 'TURTLE', 'RANDOM']
word = random.choice(words)
guessed = []

# Display the initial style
image = pygame.image.load("image_2.png")
images.append(image)
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            for i in range(5):
                if hangman_status == 1:
                    image = pygame.image.load("image_3.png")
                    images.append(image)
                elif hangman_status == 2:
                    image = pygame.image.load("image_4.png")
                    images.append(image)
                elif hangman_status == 3:
                    image = pygame.image.load("image_5.png")
                    images.append(image)
                elif hangman_status == 4:
                    image = pygame.image.load("image_6.png")
                    images.append(image)
                elif hangman_status == 5:
                    image = pygame.image.load("image_7.png")
                    images.append(image)
